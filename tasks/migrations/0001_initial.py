    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reset_token', models.CharField(blank=True, db_index=True, help_text='Password reset token', max_length=255, null=True)),
                ('reset_token_expires', models.DateTimeField(blank=True, db_index=True, help_text='When the reset token expires', null=True)),
                ('reset_attempts', models.PositiveIntegerField(default=0, help_text='Number of reset attempts in current window')),
                ('reset_attempts_reset_at', models.DateTimeField(blank=True, help_text='When reset attempts counter resets', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='tasks.product')),
            ],
            options={
                'ordering': ['order', 'id'],
            },
